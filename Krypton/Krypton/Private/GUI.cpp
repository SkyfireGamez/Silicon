...
void GUI::Init()
{
    ...
    WNDCLASS wc{};
    wc.lpszClassName = L"KyrptonWC";
    wc.lpfnWndProc = WndProc;
    RegisterClass(&wc);

    wchar_t buffer[67];
    swprintf_s(buffer, VersionInfo.EngineVersion >= 5.0 ? L"Kyrpton (FN %.2f, UE %.1f)" : (VersionInfo.FortniteVersion >= 5.00 || VersionInfo.FortniteVersion < 1.2 ? L"Kyrpton (FN %.2f, UE %.2f)" : L"Kyrpton (FN %.1f, UE %.2f)"), VersionInfo.FortniteVersion, VersionInfo.EngineVersion);
    ...
    while (!done)
    {
        ...
        ImGui::Begin("Kyrpton", nullptr, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoTitleBar);
        ...
        case 4:
            ...
            if (ImGui::Button("Dump Items"))
            {
                ...
                ss << "Generated by Kyrpton (https://github.com/plooshi/Kyrpton)\n";
                char version[6];
